...
#include "../win32/goChuViet/goChuViet/stdafx.h"
#define IS_DEBUG 1
...
/**
 * 0: No; 1: Yes
 * Temporarily turn off GoChuViet  by hot key (Command on mac, Alt on Windows and Linux)
 */
...
void vKeyHandleEvent(const vKeyEvent& event,
                     ...
                     const Uint16& data,
                     const enum eCapStatus& capsStatus=eNoCapNoShift,
...
/**
 * temporarily turn off GoChuViet engine
 */
