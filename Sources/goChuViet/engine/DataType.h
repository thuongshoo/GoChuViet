...
typedef unsigned char myByte_t;
 ...
 * 5: dấu Nặng - ạ
 */
#define MARK1_DAU_SAC_MASK                              0x80000
#define MARK2_DAU_HUYEN_MASK                              0x100000
#define MARK3_DAU_HOI_MASK                              0x200000
#define MARK4_DAU_NGA_MASK                              0x400000
#define MARK5_DAU_NANG_MASK                              0x800000
...
#define IS_NUMBER_KEY(code) ( code <= KEY_9 && code >= KEY_0)
